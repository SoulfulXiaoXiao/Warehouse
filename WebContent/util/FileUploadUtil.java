            ...
            while (iter.hasNext()) {
                ...
                if (!item.isFormField()) {
                    ...
                    if (result) {
                        ...
                        String ext = "."+AllFileFilter.getTypePart(name);
                        try {
                            //保存上传的文件到指定的目录
                            ...
                            else
                            {
                                ...
                                AllFileFilter.makeDirectory(uploadfilename);
